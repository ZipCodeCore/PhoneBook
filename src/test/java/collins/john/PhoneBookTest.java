...
public class PhoneBookTest {
    ...
    public void printEntriesTest(){
       String actual = testPhoneBook.printEntries();
        //String expected = "Test Name  215-333-5555";
        String expected = "fail";//fail test
    ...
    public void reverseLookupTest(){
        String actual = testPhoneBook.reverseLookup("215-333-5555");
        //String expected = "Test Name";
        String expected = "fail";//fail test
        assertEquals("should return Test Name, contact that has that ph#", expected, actual);
    }
    @Test
